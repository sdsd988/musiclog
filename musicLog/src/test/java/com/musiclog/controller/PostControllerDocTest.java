...
@AutoConfigureRestDocs(uriScheme = "https",uriHost = "api.musiclog.com",uriPort = 443)
        ...
        mockMvc.perform(RestDocumentationRequestBuilders.post("/posts")
                ...
                .andDo(document("post-create",
                        PayloadDocumentation.requestFields(
                                PayloadDocumentation.fieldWithPath("title").description("제목").attributes(key("constraint").value("좋은제목 입력해주세요.")),
